...
function ProjectCard({ title, description, bullets, image, tags, codeSnippet, explanation, link }) {
  ...
  return (
    <div
      className={`bg-white rounded-xl shadow-md border border-slate-100 overflow-hidden transition-all duration-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}
    >
      {image && (
